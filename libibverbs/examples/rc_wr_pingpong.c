						 ...
						 const struct pingpong_dest *my_dest)
{
	...
	int sockfd = -1;
	char gid[33];
	char msg[sizeof "00000000:0000000000000000:0000:000000:000000:00000000000000000000000000000000"];
...
int main(int argc, char *argv[])
{
	...
	while (1) {
		...
		static struct option long_options[] = {
			...
			{ .name = "unit-test", .has_arg = 0, .val = 't' },
			{ .name = "help",      .has_arg = 0, .val = 'h' },
			{}
		};

		c = getopt_long(argc, argv, "d:i:s:g:n:cth", long_options, NULL);
		if (c == -1)
			break;
